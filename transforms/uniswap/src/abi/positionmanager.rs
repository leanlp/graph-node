    ...
    pub mod functions {
        ...
        pub struct Collect {
            ...
            pub amount0_max: substreams::scalar::BigInt,
            pub amount1_max: substreams::scalar::BigInt,
        }
        impl Collect {
            const METHOD_ID: [u8; 4] = [38u8, 14u8, 18u8, 176u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[
                        ...
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
                                match self.amount0_max.clone().to_bytes_be() {
                                    (num_bigint::Sign::Plus, bytes) => bytes,
                                    (num_bigint::Sign::NoSign, bytes) => bytes,
                                    (num_bigint::Sign::Minus, _) => {
                                        panic!("negative numbers are not supported")
                        ...
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
                                match self.amount1_max.clone().to_bytes_be() {
                                    (num_bigint::Sign::Plus, bytes) => bytes,
                                    (num_bigint::Sign::NoSign, bytes) => bytes,
                                    (num_bigint::Sign::Minus, _) => {
                                        panic!("negative numbers are not supported")
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct CreateAndInitializePoolIfNecessary {
            pub token_a: Vec<u8>,
            pub token_b: Vec<u8>,
            pub fee: substreams::scalar::BigInt,
            pub sqrt_price_x96: substreams::scalar::BigInt,
        }
        impl CreateAndInitializePoolIfNecessary {
            const METHOD_ID: [u8; 4] = [19u8, 234u8, 213u8, 98u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for CreateAndInitializePoolIfNecessary {
            const NAME: &'static str = "createAndInitializePoolIfNecessary";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        for CreateAndInitializePoolIfNecessary {
            fn output(data: &[u8]) -> Result<Vec<u8>, String> {
                Self::output(data)
            }
        }
        ...
        pub struct DecreaseLiquidity {
            ...
            pub amount0_min: substreams::scalar::BigInt,
            pub amount1_min: substreams::scalar::BigInt,
            pub deadline: substreams::scalar::BigInt,
        }
        impl DecreaseLiquidity {
            const METHOD_ID: [u8; 4] = [3u8, 163u8, 242u8, 171u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[
                        ...
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
                                match self.amount0_min.clone().to_bytes_be() {
                                    (num_bigint::Sign::Plus, bytes) => bytes,
                                    (num_bigint::Sign::NoSign, bytes) => bytes,
                                    (num_bigint::Sign::Minus, _) => {
                                        panic!("negative numbers are not supported")
                        ...
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
                                match self.amount1_min.clone().to_bytes_be() {
                                    (num_bigint::Sign::Plus, bytes) => bytes,
                                    (num_bigint::Sign::NoSign, bytes) => bytes,
                                    (num_bigint::Sign::Minus, _) => {
                                        panic!("negative numbers are not supported")
        ...
        impl substreams_ethereum::Function for DecreaseLiquidity {
        ...
        pub struct IncreaseLiquidity {
            pub token_id: substreams::scalar::BigInt,
            pub amount0_desired: substreams::scalar::BigInt,
            pub amount1_desired: substreams::scalar::BigInt,
            pub amount0_min: substreams::scalar::BigInt,
            pub amount1_min: substreams::scalar::BigInt,
            pub deadline: substreams::scalar::BigInt,
        }
        impl IncreaseLiquidity {
            const METHOD_ID: [u8; 4] = [18u8, 215u8, 178u8, 196u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[
                        ...
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
                                match self.amount0_desired.clone().to_bytes_be() {
                                    (num_bigint::Sign::Plus, bytes) => bytes,
                                    (num_bigint::Sign::NoSign, bytes) => bytes,
                                    (num_bigint::Sign::Minus, _) => {
                                        panic!("negative numbers are not supported")
                        ...
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
                                match self.amount1_desired.clone().to_bytes_be() {
                                    (num_bigint::Sign::Plus, bytes) => bytes,
                                    (num_bigint::Sign::NoSign, bytes) => bytes,
                                    (num_bigint::Sign::Minus, _) => {
                                        panic!("negative numbers are not supported")
        ...
        impl substreams_ethereum::Function for IncreaseLiquidity {
        ...
        impl Permit {
            const METHOD_ID: [u8; 4] = [122u8, 194u8, 255u8, 123u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl Positions {
            const METHOD_ID: [u8; 4] = [153u8, 251u8, 171u8, 136u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct UniswapV3MintCallback {
            pub amount0_owed: substreams::scalar::BigInt,
            pub amount1_owed: substreams::scalar::BigInt,
            pub data: Vec<u8>,
        }
        impl UniswapV3MintCallback {
            const METHOD_ID: [u8; 4] = [211u8, 72u8, 121u8, 151u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
                                match self.amount0_owed.clone().to_bytes_be() {
                                    (num_bigint::Sign::Plus, bytes) => bytes,
                                    (num_bigint::Sign::NoSign, bytes) => bytes,
                                    (num_bigint::Sign::Minus, _) => {
                                        panic!("negative numbers are not supported")
                        ...
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
                                match self.amount1_owed.clone().to_bytes_be() {
                                    (num_bigint::Sign::Plus, bytes) => bytes,
                                    (num_bigint::Sign::NoSign, bytes) => bytes,
                                    (num_bigint::Sign::Minus, _) => {
                                        panic!("negative numbers are not supported")
        ...
        impl substreams_ethereum::Function for UniswapV3MintCallback {
            const NAME: &'static str = "uniswapV3MintCallback";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
